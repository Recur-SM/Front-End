...
const Tabbar: React.FC = () => {
  return (
    /* 전체 바 */
    <div className="fixed bottom-0 w-[100vw] h-[6.87vh] px-[11.16vw] flex justify-between items-center rounded-t-[7.44vw] bg-white shadow-[0_-0.43vh_1.16vw_rgba(0,0,0,0.05)]">
